...
val unindent    = "com.davegurnell"    %% "unindent"     % "1.1.0"
val fastparse   = "com.lihaoyi"        %% "fastparse"    % "2.2.4"
val catsCore    = "org.typelevel"      %% "cats-core"    % "2.1.0"
val simulacrum  = "org.typelevel"      %% "simulacrum"   % "1.0.0"
val scalatest   = "org.scalatest"      %% "scalatest"    % "3.1.1"

lazy val typeclub = project
  .in(file("."))
  .settings(commonCompilerSettings)
  .settings(
    name := "typeclub",
    libraryDependencies ++= Seq(commonsLang, fastparse, scalatest % Test)
  )
